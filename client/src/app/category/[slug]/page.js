...
function ProductCardSkeleton() {
    return (
        <div className="bg-[#FFFEF9] rounded-md overflow-hidden animate-pulse border border-[#D4AF37]/15">
            <div className="h-52 w-full bg-[#FAF6F0]"></div>
            <div className="p-4">
                <div className="h-3 bg-[#D4AF37]/20 rounded w-1/2 mx-auto mb-2"></div>
                <div className="h-4 bg-[#FAF6F0] rounded w-full mb-2"></div>
                <div className="h-4 bg-[#FAF6F0] rounded w-3/4 mx-auto mb-3"></div>
                <div className="h-5 bg-[#D4AF37]/20 rounded w-1/3 mx-auto"></div>
            </div>
        </div>
    );
}
...
export default function CategoryPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FAF6F0]">
            {/* Hero Section */}
            <section className="relative py-10 md:py-14 bg-gradient-section overflow-hidden">
                <div className="absolute inset-0 opacity-30">
                    <div className="absolute top-10 right-20 w-60 h-60 bg-[#D4AF37]/10 rounded-full blur-3xl" />
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4">
                    ...
                    <div className="flex items-center text-sm mb-4">
                        ...
                        <Link href="/categories" className="text-[#7B2D26]/60 hover:text-[#D4AF37] transition-colors">Categories</Link>
                        <span className="mx-2 text-[#7B2D26]/40">/</span>
                        <span className="text-[#D4AF37] font-medium">{category?.name}</span>
                    </div>

                    <div className="flex flex-col md:flex-row md:items-center gap-5">
                        {/* Category Image */}
                        {category?.image && (
                            <div className="w-20 h-20 md:w-24 md:h-24 rounded-md bg-[#FFFEF9] border border-[#D4AF37]/30 overflow-hidden flex-shrink-0 shadow-sm">
                                <Image
                        ...
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#D4AF37]/15 border border-[#D4AF37]/30 rounded-md text-[#D4AF37] text-sm font-medium mb-2">
                                <Volume2 className="w-3.5 h-3.5" />
                                {pagination.total} Products
                            </div>
                            <h1 className="text-2xl md:text-4xl font-bold text-[#6A1E1E] mb-1">
                                {category?.name}
                            </h1>
                            {category?.description && (
                                <p className="text-[#7B2D26]/70 max-w-2xl">{category.description}</p>
                            )}
                        </div>
                    </div>
                </div>
