...
function ProductCardSkeleton() {
    return (
        <div className="bg-[#FFFEF9] overflow-hidden rounded-md animate-pulse border border-[#D4AF37]/15 shadow-sm">
            <div className="h-56 w-full bg-gradient-to-br from-[#FAF6F0] to-[#F5E6B8]/30"></div>
            <div className="p-4">
                <div className="h-3 w-16 bg-[#D4AF37]/20 rounded-md mx-auto mb-3"></div>
                <div className="h-4 w-full bg-[#FAF6F0] rounded mb-2"></div>
                <div className="h-4 w-3/4 mx-auto bg-[#FAF6F0] rounded mb-4"></div>
                <div className="h-6 w-20 bg-[#D4AF37]/20 rounded-md mx-auto"></div>
            </div>
        </div>
    );
}
    ...
    return (
        <> <div className="hidden lg:flex mx-auto w-full">
            ...
            <div id="products-main">
                <div>
                    {/* Hero Banner */}
                    <div className="relative w-full h-[180px] md:h-[280px] mb-6 md:mb-10 rounded-md overflow-hidden shadow-lg border border-[#D4AF37]/20">
                        <Image src="/banner-background.jpg" alt="Premium Indian Namkeen" fill className="object-cover object-top" priority />
                        <div className="absolute inset-0 bg-gradient-to-r from-[#6A1E1E]/95 via-[#6A1E1E]/70 to-transparent">
                            <div className="h-full flex flex-col justify-center px-6 md:px-12 max-w-2xl">
                                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#D4AF37]/20 backdrop-blur-sm border border-[#D4AF37]/40 rounded-md text-[#D4AF37] text-xs md:text-sm font-medium w-fit mb-3 md:mb-4">
                                ...
                                <h1 className="text-2xl md:text-5xl font-bold text-[#FAF6F0] mb-2 md:mb-3">Traditional Indian Namkeen</h1>
                                <p className="text-sm md:text-lg text-[#FAF6F0]/80 leading-relaxed">Discover our collection of authentic Indian snacks made with pure ingredients and time-honored recipes.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                        {/* Filters Sidebar */}
                        <div className={`md:w-1/4 lg:w-1/5 ${mobileFiltersOpen ? "block fixed inset-0 z-50 bg-[#FFFEF9] p-4 overflow-auto" : "hidden"} md:block md:static md:z-auto md:bg-transparent md:p-0`}>
                            <div className="bg-[#FFFEF9] rounded-md shadow-sm border border-[#D4AF37]/20 sticky top-32">
                                <div className="flex items-center justify-between p-4 border-b border-[#D4AF37]/20">
                                    <h2 className="text-base font-bold text-[#6A1E1E]">Filters</h2>
                                    <div className="flex items-center gap-3">
                                        <button onClick={clearFilters} className="text-xs text-[#D4AF37] font-medium hover:underline">Clear all</button>
                                        <button className="md:hidden p-1.5 text-[#6A1E1E] hover:bg-[#D4AF37]/10 rounded-md" onClick={() => setMobileFiltersOpen(false)}><X className="h-5 w-5" /></button>
                                    </div>
                                </div>
    ...
    return (
        <div className="min-h-screen bg-[#FAF6F0]">
            <div className="container mx-auto px-4 py-6">
                <ClientOnly fallback={<div className="flex flex-col justify-center items-center h-64 gap-3"><div className="w-12 h-12 border-4 border-[#D4AF37] border-t-transparent rounded-full animate-spin"></div><p className="text-sm text-[#7B2D26]/60">Loading...</p></div>}>
                    <Suspense fallback={<div className="flex flex-col justify-center items-center h-64 gap-3"><div className="w-12 h-12 border-4 border-[#D4AF37] border-t-transparent rounded-full animate-spin"></div><p className="text-sm text-[#7B2D26]/60">Loading...</p></div>}>
                        <ProductsContent />
                    </Suspense>
                </ClientOnly>
            </div>
